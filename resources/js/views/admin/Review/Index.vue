        ...
        <div class="admin-list__body">
            ...
            <div class="admin-list__form-control" v-for="(element, index) in elements">
                ...
                <div class="admin-list__form-control-item">
                    <router-link class="admin-list__link" :to="{ name: 'admin.review.edit', params: {id: element.id} }">{{ element.title }}</router-link>
                </div>
                <div class="admin-list__form-control-item">
                    {{ element.link }}
                </div>
                <div class="admin-list__form-control-item">
                    <input @click.prevent="deleteReview(element.id)" class="admin-list__remove" type="submit" value="x">
                </div>
            </div>
